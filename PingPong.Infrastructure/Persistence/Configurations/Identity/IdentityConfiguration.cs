...
namespace PingPong.Infrastructure.Persistence.Configurations.Identity;
...
public class ApplicationUserConfiguration : IEntityTypeConfiguration<ApplicationUser>
{
    public void Configure(EntityTypeBuilder<ApplicationUser> builder)
    {
        ...
        builder.HasMany(u => u.FavoritePartners)
            .WithOne(fp => fp.User)
...
public class UserFavoritePartnerConfiguration : IEntityTypeConfiguration<UserFavoritePartner>
{
    public void Configure(EntityTypeBuilder<UserFavoritePartner> builder)
    {
        builder.ToTable("UserFavoritePartners");
        builder.HasKey(fp => new { fp.UserId, fp.PartnerId });

        builder.Property(fp => fp.UserId)
            .HasMaxLength(StringLengths.UserId)
            .IsRequired();

        builder.Property(fp => fp.PartnerId)
